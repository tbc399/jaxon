		...
		if len(accounts) > 0 {
			for acctType, accountList := range accounts {
				...
				for _, account := range accountList {
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<div class=\"flex flex-col rounded-lg w-full dark:bg-slate-800/50 dark:text-gray-100 p-4\"><div class=\"flex flex-row justify-between mb-4\"><div class=\"flex flex-row gap-x-2 items-center\"><div class=\"text-sm font-semibold\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
